    ...
    for (const site of sites) {
      try {
        ...
        const manualPosts = wpPosts.filter(post => {
          ...
          console.log(`No match found - post ID ${post.id} does not exist in our submissions - this is a manual post`);
          return true; // This is a manual post
        });
