...
3.  **Organic Link Integration:** Include 2 or 3 additional hyperlinks to *different*, *external*, *authoritative* websites relevant to the article's specific subject.
...
4.  **Link Count:** The final article must contain exactly 3 or 4 hyperlinks in total (1 primary link + 2 or 3 organic links).
