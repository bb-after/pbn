...
const SuperstarSiteSubmissionsTable = () => {
  ...
  const fetchData = (query = "", page = 0, rowsPerPage = 10) => {
    ...
    if (selectedUser) {
      apiUrl += `&userToken=${selectedUser}`;
    }
    
    if (selectedAuthor) {
      apiUrl += `&authorId=${selectedAuthor}`;
    }
    
    if (selectedAutogenerated !== "") {
      apiUrl += `&autogenerated=${selectedAutogenerated}`;
    }
  ...
  }, [search, page, rowsPerPage, selectedUser, selectedAuthor, selectedAutogenerated]);

  // Search handler
  const handleSearch = () => {
    setPage(0); // Reset to first page when searching
    fetchData(search, 0, rowsPerPage);
  };
              ...
              <TableRow key={submission.id}>
                ...
                <TableCell>
                  {submission.author_name ? (
                    <Box display="flex" alignItems="center">
                      ...
                      <div>
                        <Typography variant="body2">{submission.author_name}</Typography>
                ...
                <TableCell>
                  {submission.autogenerated === 1 ? 
                    <Typography variant="body2" color="primary">Autogenerated</Typography> : 
                    <Typography variant="body2" color="secondary">Manual</Typography>
                  }
                </TableCell>
                <TableCell>
