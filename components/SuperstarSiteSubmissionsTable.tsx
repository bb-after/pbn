...
const SuperstarSiteSubmissionsTable = () => {
  ...
  const fetchData = (query = "", page = 0, rowsPerPage = 10) => {
    let apiUrl = `/api/superstar-site-submissions?page=${page}&rowsPerPage=${rowsPerPage}`;
    if (query) {
            ...
            <TableBody>
              {submissions.map((submission: any) => (
                <TableRow key={submission.id}>
                  ...
                  <TableCell>---Author (coming soon)---</TableCell>
                  <TableCell>{submission.autogenerated}</TableCell>
                  <TableCell>
