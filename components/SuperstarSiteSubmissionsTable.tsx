...
import SiteClientPostsModal from './SiteClientPostsModal';
...
const SuperstarSiteSubmissionsTable = () => {
  ...
  // State for the client posts modal
  ...
  // Function to open the client posts modal
  const handleOpenClientPostsModal = (siteId: number, siteName: string) => {
  ...
  return (
    <div>
            ...
            {submissions.map((submission: any) => {
              ...
              return (
                <TableRow key={submission.id}>
                  ...
                  <TableCell>{siteStat ? siteStat.unique_clients : '—'}</TableCell>
                  <TableCell>
                    {siteStat ? (
                      <Tooltip title="Click to view client posts">
                        <Button
                          size="small"
                          onClick={() =>
                            handleOpenClientPostsModal(
                              siteStat.site_id,
                              siteStat.site_name || siteStat.site_domain
                            )
                          }
                        >
                          {siteStat.total_posts}
                        </Button>
                      </Tooltip>
                    ) : (
                      '—'
      ...
      {/* Modal for client posts */}
      {isModalOpen && selectedSiteId && (
        <SiteClientPostsModal
          open={isModalOpen}
