...
describe('formatSuperstarContent', () => {
  ...
  it('should remove any instance of "# " from the body', () => {
    const content = 'This is a test. # This should be removed.';
    const result = formatSuperstarContent(content, 'Title');
    expect(result.content).toBe('This is a test. This should be removed.\n\n');
  });
  ...
  it('should remove any instances of multiple line breaks with a single line break', () => {
    const content = 'This is a test.\n\n\n\nThis should be single spaced.';
    const result = formatSuperstarContent(content, 'Title');
    expect(result.content).toBe('This is a test.\n\nThis should be single spaced.\n\n');
  });

  it('should remove leading spaces from the start of each line', () => {
    const content = '  This is a test.\n  This should have no leading spaces.';
    const result = formatSuperstarContent(content, 'Title');
    expect(result.content).toBe('This is a test.\nThis should have no leading spaces.\n\n');
  });
